...
<body>
  <div class="login-box">
    ...
    <h1> <i class="fa-solid fa-house-medical-circle-exclamation" style="margin-right: 10px;"></i>Update Password</h1>
    <form method="POST" action="{{route('hpassupdatee')}}">
        @csrf
        @method('PUT')
      <div class="user-box">
      ...
      <center>
        <button onclick="notify()" class="submit">Update</button>
    </form>
  </div></center>
